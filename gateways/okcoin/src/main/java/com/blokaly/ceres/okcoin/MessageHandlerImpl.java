...
public class MessageHandlerImpl implements MessageHandler {
  ...
  private final Provider<OKCoinClient> clientProvider;
  private final OrderBookKeeper bookKeeper;
  private final ToBProducer producer;

  @Inject
  public MessageHandlerImpl(Gson gson, Provider<OKCoinClient> clientProvider, OrderBookKeeper bookKeeper, ToBProducer producer) {
    this.gson = gson;
  ...
  private void subscribeAll() {
    OKCoinClient sender = clientProvider.get();
    if (sender == null) {
