...
@Singleton
public class GdaxKafkaProducer {
  private static Logger LOGGER = LoggerFactory.getLogger(GdaxKafkaProducer.class);
  ...
  @Inject
  public GdaxKafkaProducer(Producer<String, String> producer, Gson gson, Config config) {
